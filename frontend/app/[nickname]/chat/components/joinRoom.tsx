...
const JoinRoomForm = () => {
  ...
  return (
    showJoinForm &&
        <div className='backdrop-blur-md z-10 bg-transparent flex justify-center items-center w-[100%] h-[100vh]'>
            <div className=' scale-110 w-[30%] h-[30vh] p-6 bg-slate-600 rounded-2xl flex flex-col items-center justify-center min-w-[300px]'>
