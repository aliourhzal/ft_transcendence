  ...
  const OthersChatBox:React.FC<SelfChatBoxProps> = (msg) => {
    ...
    return (
        <div className={'z-0 flex items-start justify-start gap-3 m-2 my-4'} key={gimmeRandom()}>
            <img className="bg-white rounded-full w-30 h-30 border-2 border-slate-300 w-10 h-10" width={10} height={10} src={msg.user ? msg.user.profilePic : '/images/unknownUser.png'}/>
