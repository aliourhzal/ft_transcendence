...
const ButtomButtons = () => {
  ...
  return (
    <div className='transition-all flex justify-between items-center w-[50%] h-[8%]'>
        ...
        >
            ...
            {create && <div className='transition-all drop-shadow-[0px_0px_5px_rgba(150,150,150,0.8)] font-bold text-xs absolute top-[140%] bg-slate-400 opacity-80 w-14 rounded-lg'>create room</div>}
        </div>
        <div className='transition-all hover:scale-110 relative cursor-pointer border-blue-500 border-[6px] bg-blue-500 rounded-full h-10 w-10 flex items-center justify-center' onClick={ () => {
